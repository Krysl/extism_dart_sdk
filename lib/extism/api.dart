...
class Extism {
  ...
  ffi.Pointer<ffi.Uint8> currentPluginMemory(
    ...
    return _lib.extism_current_plugin_memory(plugin);
  }

  /// Allocate a memory block in the currently running plugin
  /// NOTE: this should only be called from host functions.
  int currentPluginMemoryAlloc(
    ffi.Pointer<ExtismCurrentPlugin> plugin,
    int n,
  ) {
    return _lib.extism_current_plugin_memory_alloc(
      plugin,
      n,
    );
  }
  ...
  int currentPluginMemoryLength(
    ...
    return _lib.extism_current_plugin_memory_length(
      plugin,
      n,
    );
  }
  ...
  void currentPluginMemoryFree(
    ...
    return _lib.extism_current_plugin_memory_free(
      plugin,
      ptr,
    );
  }
  ...
  ffi.Pointer<ExtismFunction> functionNew(
    ...
    List<int> inputs,
    List<int> outputs,
    // DartExtismFunctionTypeFunction func,
    ...
    final ins = calloc.call<ffi.Int32>(inputsNum)
      ..asTypedList(inputsNum).setAll(0, inputs.cast());
    final outs = calloc.call<ffi.Int32>(outputsNum)
      ..asTypedList(outputsNum).setAll(0, outputs.cast());
    ...
    return _lib.extism_function_new(
      ...
      outs,
      outputsNum,
      // ffi.Pointer.fromFunction<ExtismFunctionTypeFunction>(func),
      func.nativeFunction,
      userData,
      ffi.NativeCallable<
  ...
  void extismFunctionFree(
    ...
    return _lib.extism_function_free(
      f,
    );
  }

  /// Set the namespace of an `ExtismFunction`
  void extismFunctionSetNamespace(
    ffi.Pointer<ExtismFunction> ptr,
    String namespace,
  ) {
    return _lib.extism_function_set_namespace(
      ptr,
  ...
  ffi.Pointer<ExtismPlugin> pluginNew(
    ...
    for (var (index, fn) in functions.indexed) {
      fns[index] = fn;
    }
  ...
  void pluginNewErrorFree(
    ...
    return _lib.extism_plugin_new_error_free(
      err.val.value,
    );
  }
  ...
  void pluginFree(
    ...
    return _lib.extism_plugin_free(
      plugin,
    );
  }
  ...
  ffi.Pointer<ExtismCancelHandle> pluginCancelHandle(
    ...
    return _lib.extism_plugin_cancel_handle(
      plugin,
    );
  }
  ...
  bool pluginCancel(
    ...
    return _lib.extism_plugin_cancel(
      handle,
    );
  }
  ...
  bool pluginConfig(
    ...
    ffi.Pointer<ffi.Uint8> json = jsonConfig.toNativeUtf8().cast();
  ...
  int pluginOutputLength(
    ...
    return _lib.extism_plugin_output_length(
      plugin,
    );
  }

  /// Get a pointer to the output data
  String extismPluginOutputData(
    ffi.Pointer<ExtismPlugin> plugin,
  ) {
    return _lib
  ...
  bool pluginReset(
    ...
    return _lib.extism_plugin_reset(
      plugin,
    );
  }
  ...
  String get version {
    return _lib.extism_version().cast<Utf8>().toDartString();
  }
}
