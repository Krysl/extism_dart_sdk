...
class _SymbolAddresses {
  final LibExtism _library;
  _SymbolAddresses(this._library);
  ffi.Pointer<
          ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ExtismFunction>)>>
      get extism_function_free => _library._extism_function_freePtr;
}

typedef va_list = ffi.Pointer<ffi.Char>;

/// An enumeration of all possible value types in WebAssembly.
abstract class _ExtismValType {
...
const int VCRT_COMPILER_PREPROCESSOR = 1;

const int SAL_VERSION = 20;

const int SAL_H_VERSION = 180000000;

const int USE_DECLSPECS_FOR_SAL = 0;

const int USE_ATTRIBUTES_FOR_SAL = 0;

const int CRT_PACKING = 8;

const int VCRUNTIME_DISABLED_WARNINGS = 4514;

const int HAS_EXCEPTIONS = 1;

const int WCHAR_T_DEFINED = 1;

const int NULL = 0;

const int HAS_CXX17 = 0;

const int HAS_CXX20 = 0;

const int HAS_CXX23 = 0;

const int HAS_NODISCARD = 1;
